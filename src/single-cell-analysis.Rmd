...
# Working directory
setwd("C:/Users/Valentin/Desktop/EPFL/MAII/SCB/single_cell_analysis/")
```
...
Reducing dimensionality allows us to visualize the data, and gives us some idea about what clusters may be present. On a 3D interactive plot, we can visually identify 4 clusters. viz_eig function allows to determine what is the optimal number of cluster. The resulting histogram also shows that the optimal number of cluster is also 4.
